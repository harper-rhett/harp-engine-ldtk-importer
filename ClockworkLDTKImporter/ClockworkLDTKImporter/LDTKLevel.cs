...
public class LDTKLevel
{
	...
	public readonly Dictionary<string, LayerInstance> LayersByName = new();
	...
	public LDTKLevel(Level levelData)
	{
		...
		Fields = LDTKContainer.DeserializeFields(levelData.FieldInstances);
	}

	private void DeserializeLayers(Level levelData)
	{
		foreach (LayerInstance layerData in levelData.LayerInstances) LayersByName[layerData.Identifier] = layerData;
	}
}